...
4. Replace **497196579670** in the whole project with your AWS Account ID
...
# Datacenter Map
Remember to adjust **497196579670** in workflow before execution.
...
You also need to update task.json and replace **arn:aws:secretsmanager:eu-central-1:497196579670:secret:aws-upskilling-secret-cicd-Zi4oXb** with ARN of your secrets manager.
**REMEMBER!** Push all changes to your forked repository!
...
* Replaced 497196579670 in the whole project (replace all in all files) with your AWS Account ID
  * **REMEMBER!** Push all changes to your forked repository!
