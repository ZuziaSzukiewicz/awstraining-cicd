...
You also need to update task.json and replace **arn:aws:secretsmanager:eu-central-1:497196579670:secret:secret-backend-71QsOo** with ARN of your secrets manager.
**REMEMBER!** Push all changes to your forked repository!
